  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="https://marsbracelets.42web.io" target="_blank">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">SSESSION table</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">LAST DATE ACTIVE</th>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <?php echo('<img src="'.$location.'" alt="profile_image"class="avatar avatar-sm me-3 border-radius-lg" alt="user1"> <br>'); ?>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $state; ?></p>
                        <p class="text-xs text-secondary mb-0">Organization</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $state; ?>Online</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <p class="text-xs text-secondary mb-0">NSAMBYA</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $state; ?></p>
                        <p class="text-xs text-secondary mb-0">PALLISA</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $state; ?>Online</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">MBALE</p>
                        <p class="text-xs text-secondary mb-0">MBALE TOWN</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary">Offline</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $state; ?></p>
                        <p class="text-xs text-secondary mb-0">MUKONO</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $state; ?>Online</span>
                      </td>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">SESSIONS</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
